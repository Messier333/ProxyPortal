...
class Component extends HTMLElement {
  ...
  resources = {
    ...
    localFonts: {
      roboto: '<link rel="stylesheet" href="portal/src/fonts/roboto-local.css">',
      nunito: '<link rel="stylesheet" href="portal/src/fonts/nunito-local.css">',
      raleway: '<link rel="stylesheet" href="portal/src/fonts/raleway-local.css">',
    },
    /** Icon font libraries */
    icons: {
      material:
        '<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" type="text/css">',
      materialLocal: '<link rel="stylesheet" href="portal/src/fonts/material-icons-local.css">',
      cryptofont: '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/monzanifabio/cryptofont/cryptofont.css">',
      tabler: '<link rel="stylesheet" href="portal/src/css/tabler-icons.min.css">',
    },
    /** CSS libraries and frameworks */
    libs: {
      awoo: '<link rel="stylesheet" type="text/css" href="portal/src/css/awoo.min.css">',
      awooLocal: '<link rel="stylesheet" type="text/css" href="portal/src/css/awoo-local.min.css">',
    },
  };
